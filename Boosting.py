...
# madelon_booster = AdaBoostClassifier(algorithm='SAMME',learning_rate=1,base_estimator=svc,random_state=55)
# adult_booster = AdaBoostClassifier(algorithm='SAMME',learning_rate=1,base_estimator=svc,random_state=55)
# OF_booster = AdaBoostClassifier(algorithm='SAMME',learning_rate=1,base_estimator=svc,random_state=55)
