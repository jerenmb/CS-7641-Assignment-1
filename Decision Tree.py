...
pipeM = Pipeline([('Scale',StandardScaler()),
                 ('Cull1',SelectFromModel(RandomForestClassifier(random_state=1, n_estimators=10),threshold='median')),
                 ('Cull2',SelectFromModel(RandomForestClassifier(random_state=2, n_estimators=10),threshold='median')),
                 ('Cull3',SelectFromModel(RandomForestClassifier(random_state=3, n_estimators=10),threshold='median')),
                 ('Cull4',SelectFromModel(RandomForestClassifier(random_state=4, n_estimators=10),threshold='median')),
